    ...
    <el-container class="article-management">
        <el-header class="article-management__header">
            <div class="article-management__header-main">
                <el-input v-model="searchKey" placeholder="请输入文章ID / 文章标题" class="management__headerInput"
                    style="width:300px"></el-input>
                <el-button type="primary" size="small" @click="search" style="margin-right: 120px;">搜索</el-button>
                <el-button type="success" size="small" @click="handleAdd">新增文章</el-button>
            </div>

        </el-header>
        <el-main class="article-management__content">
            <div class="table-container" ref="container">
                <el-table :data="datas" style="width: 100%" ref="table" :height="tableHeight" align="center"
                    header-align="center">
                    <el-table-column label="ID" prop="id" width="60"></el-table-column>
                    <el-table-column label="来源" prop="classify"></el-table-column>
                    ...
                    <el-table-column label="封面" width="200">
                        <template slot-scope="scope">
                            <el-image :src="scope.row.bg" v-if="scope.row.bg"></el-image>
                        </template>
                    </el-table-column>
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <el-button type="danger" size="small" @click="handlePreview(scope.row)"
                                v-if="scope.row.type !== 'admin'">预览</el-button>
